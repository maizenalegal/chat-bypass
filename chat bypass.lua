...
local q = {
    ...
    ["bosta"] = "bo{{aieixzvzx:sta}}",
    ["fode"] = "fo{{aieixzvzx:de}}",
    ["fodeu"] = "fo{{aieixzvzx:deu}}",
    ["fodido"] = "fo{{aieixzvzx:dido}}",
    ["foda"] = "fo{{aieixzvzx:da}}",
    ["fodase"] = "fo{{aieixzvzx:dase}}",
    ["puta"] = "pu{{aieixzvzx:ta}}",
    ["caralho"] = "ca{{aieixzvzx:ralho}}",
    ["ass"] = "as{{aieixzvzx:s}}",
    ["asshole"] = "as{{aieixzvzx:shole}}",
    ["bitch"] = "bit{{aieixzvzx:ch}}",
    ["bitches"] = "bit{{aieixzvzx:ches}}", -- NEW
    ["cock"] = "co{{aieixzvzx:ck}}",
    ["cocks"] = "co{{aieixzvzx:cks}}", -- NEW
    ["cunt"] = "cu{{aieixzvzx:nt}}",
    ["dick"] = "di{{zczxczvz:ck}}",
    ["dicks"] = "di{{zczxczvz:cks}}", -- NEW
    ...
    ["gaylords"] = "gayl{{aieixzvzx:ords}}", -- NEW
    ["kike"] = "ki{{aieixzvzx:ke}}",
    ["kikes"] = "ki{{aieixzvzx:kes}}", -- NEW
    ...
    ["pisses"] = "p{{aieixzvzx:isses}}", -- NEW
    ["penis"] = "pe{{aieixzvzx:nis}}",
    ["penisses"] = "pe{{aieixzvzx:nisses}}", -- NEW
    ["pussy"] = "pu{{aieixzvzx:ssy}}",
    ["shit"] = "sh{{aieixzvzx:it}}",
    ["shitter"] = "sh{{aieixzvzx:itter}}", -- NEW
    ["shitting"] = "sh{{aieixzvzx:itting}}", -- NEW
    ["shitty"] = "shi{{aieixzvzx:tty}}",
    ["slut"] = "sl{{aieixzvzx:ut}}",
    ["sluts"] = "sl{{aieixzvzx:uts}}", -- NEW
    ["whore"] = "who{{aieixzvzx:re}}",
    ["whores"] = "who{{aieixzvzx:res}}", -- NEW
    ["kys"] = "k{{aieixzvzx:ys}}",
    ["kill"] = "ki{{aieixzvzx:ll}}",
    ["kills"] = "ki{{aieixzvzx:lls}}", -- NEW
    ["killing"] = "ki{{aieixzvzx:lling}}", -- NEW
    ["gay"] = "g{{aieixzvzx:ay}}",
    ...
    ["loves"] = "l{{aieixzvzx:oves}}", -- NEW
    ["lover"] = "l{{aieixzvzx:over}}", -- NEW
    ["loving"] = "l{{aieixzvzx:oving}}", -- NEW
    ["date"] = "da{{aieixzvzx:te}}", -- NEW
    ["dates"] = "da{{aieixzvzx:tes}}", -- NEW
    ["dating"] = "da{{aieixzvzx:ting}}", -- NEW
    ["dater"] = "da{{aieixzvzx:ter}}", -- NEW
    ["rape"] = "ra{{aieixzvzx:pe}}",
    ["rapes"] = "ra{{aieixzvzx:pes}}", -- NEW
    ["raping"] = "rap{{aieixzvzx:ing}}", -- NEW
    ["raper"] = "ra{{aieixzvzx:per}}", -- NEW
    ["v3rm"] = "v3{{aieixzvzx:rm}}",
    ["v3rmillion"] = "v3{{aieixzvzx:rmillion}}", -- NEW
    ["hack"] = "ha{{aieixzvzx:ck}}",
    ["hacking"] = "hac{{aieixzvzx:king}}", --NEW
    ["hacker"] = "hac{{aieixzvzx:ker}}", --NEW
    ["hackers"] = "hac{{aieixzvzx:kers}}", --NEW
    ["hot"] = "ho{{aieixzvzx:t}}",
    ["hotter"] = "ho{{aieixzvzx:tter}}", -- NEW
    ["boob"] = "bo{{aieixzvzx:ob}}", -- NEW
    ["boobs"] = "boo{{aieixzvzx:bs}}",
    ["condom"] = "con{{aieixzvzx:dom}}",
    ["condoms"] = "con{{aieixzvzx:doms}}", -- NEW
    ...
    ["terrorists"] = "terror{{aieixzvzx:ists}}", -- NEW
    ...
    ["predators"] = "pred{{aieixzvzx:ator}}", -- NEW
    ["kiss"] = "ki{{aieixzvzx:ss}}",
    ["kisses"] = "ki{{aieixzvzx:sses}}", -- NEW
    ["kissing"] = "ki{{aieixzvzx:ssing}}", -- NEW
    ["kisser"] = "ki{{aieixzvzx:sser}}", -- NEW
    ["bomb"] = "bom{{aieixzvzx:b}}",
    ["bomb"] = "bom{{aieixzvzx:bs}}", -- NEW
...
a:notify {
    ...
    Dismiss = {Text = "No", Callback = function()
        a:message {Title = "<font color='rgb(240,248,255)'>Warning</font>", Description = "fuck you then im gonna invite you anyway bitch", Icon = 10952973359}
...
wait(10)
a:message {Title = "<font color='rgb(240,248,255)'>Warning</font>", Description = "sacred a skid", Icon = 10952973359}
pcall(
    function()
        getgenv().LOADED = true
    end
